...
<div class="summary-stats">
  ...
  <div class="stats-grid">
    ...
    <div class="stat-item">
      <span class="stat-number">3197</span>
    ...
    <li class="product-item">
      <a href="Email/Collaboration%20sensor" class="product-link">
        <div class="product-info">
          ...
          <span class="field-count">30 fields</span>
        </div>
      </a>
    </li>
    <li class="product-item">
      <a href="Email/Email%20Security" class="product-link">
        <div class="product-info">
    ...
    <li class="product-item">
      <a href="Endpoint/Endpoint%20Sensor" class="product-link">
        <div class="product-info">
          ...
          <span class="field-count">394 fields</span>
        </div>
      </a>
    </li>
  </ul>
...
<div class="layer-section">
  ...
  <ul class="product-list">
    ...
    <li class="product-item">
      <a href="Network/Web%20Security" class="product-link">
        <div class="product-info">
